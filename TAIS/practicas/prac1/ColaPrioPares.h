...
/**
 Excepción generada cuando el array esta lleno.
 */
...
#ifndef EX_COLAPRIOREPE_TAD
#define EX_COLAPRIOREPE_TAD
...
public:
    EElemRepe() {};
    EElemRepe(const string &msg) : ExcepcionTAD(msg) {}
};
...
template <class T, bool(*antes)(const T &, const T &)>
inline ostream& operator<<(ostream& o,const ColaPrioPares<T, antes>& a){
    a.mostrar(o);
    return o;
}
